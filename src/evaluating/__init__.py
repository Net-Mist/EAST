...
def resize_image(image, max_side_len=2400):
    ...
    Returns: the resize image and the resize ratio
    """
...
def detect(score_map, geo_map, timer, score_map_thresh=0.8, box_thresh=0.1, nms_thres=0.2):
    ...
    Args:
        score_map: output of the network
        geo_map: output of the network
        timer:
    ...
    # sort the text boxes via the x axis
    ...
    # boxes is a array of arrays [x1, y1, ... x4, y4, proba]
